...
You can name you project and set a hugo theme. The default theme is Yihui's lithium, which is simple and clean. You can select one theme that you like in [Hugo Themes](https://themes.gohugo.io/)
